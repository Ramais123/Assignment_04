...
with col2:
    if st.button("Stop Timer ⏹"):
        ...
        st.session_state.remaining_time = 10  # Reset to default time   
        st.session_state.running = False       
        st.success("⏹ Timer Stopped! Click 'Start' to resume.")

st.markdown(
    "<h2" \
    " style='font-size:14px; color:#555;'>Made with ❤️ by Your Muhammad Ramais Khan </h2>", 
    unsafe_allow_html=True
)